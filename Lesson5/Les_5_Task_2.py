...
while True:
    ...
    for i in range(len(inp1)):
        if ((ord(inp1[i]) >= 65) and (ord(inp1[i]) <= 70)) or ((ord(inp1[i]) >= 48) and (ord(inp1[i]) <= 57)) or (
                ord(inp1[i]) == 45):
            if (ord(inp1[i]) == 45):
                r1 = -1
            else:
    ...
    for i in range(len(inp2)):
        if ((ord(inp2[i]) >= 65) and (ord(inp2[i]) <= 70)) or ((ord(inp2[i]) >= 48) and (ord(inp2[i]) <= 57)) or (
                ord(inp1[i]) == 45):
            if (ord(inp2[i]) == 45):
                r2 = -1
            else:
...
h = defaultdict(int)
h = {'F': 15, 'E': 14, 'D': 13, 'C': 12, 'B': 11, 'A': 10, '9': 9, '8': 8, '7': 7, '6': 6, '5': 5, '4': 4, '3': 3,
     '2': 2, '1': 1, '0': 0}
